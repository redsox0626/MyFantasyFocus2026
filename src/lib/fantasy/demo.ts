  ...
  matchups: [
    {
      ...
      myTeam: { name: "Kings", abbrev: "KINGS", score: 104.2 },
      oppTeam: { name: "The Boys", abbrev: "THEBOY", score: 91.0 },
      status: "winning",
    },
    {
      id: "demo-sunset",
      ...
      myTeam: { name: "Sunset", abbrev: "SUNSET", score: 78.4 },
      oppTeam: { name: "Rivers", abbrev: "RIVERS", score: 88.1 },
      status: "losing",
    },
  ],
  meta: {
