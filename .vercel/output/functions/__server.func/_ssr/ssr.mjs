...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BUQOjZC4.mjs");
...
var manifest = {
	"0a25e930827fb0f3144bef45b9cfc0ce5f1a032abad79564eb7b0e4ec44e9447": {
		functionName: "getBootstrap_createServerFn_handler",
		importer: () => import("./functions-CMEOdmJV.mjs")
	},
	"26c449fad815004f33a5935a96b3a508965a80f1e1a185c307b9140acc282662": {
		functionName: "getEspnTeams_createServerFn_handler",
		importer: () => import("./functions-CMEOdmJV.mjs")
	},
	"a221d77796c553f9e500f9c85c8155acd7162ecbb81346cd9d67541ef7c3007f": {
		functionName: "lookupSleeperUsers_createServerFn_handler",
		importer: () => import("./functions-CMEOdmJV.mjs")
	},
	"d8c2015cfab9ed22853e4ef74e389aaed027105c33eabef89c10815e6cd8e628": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BL-Dy3rS.mjs").then((n) => n.t),
