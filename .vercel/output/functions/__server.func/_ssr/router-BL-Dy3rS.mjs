...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BL-Dy3rS.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 overflow-hidden rounded-md bg-elevated px-2 py-1.5 text-xs text-fg shadow-border", className),
	...props
}) }));
TooltipContent.displayName = Content2.displayName;
var styles_default = "/assets/styles-fUBB9YVR.css";
var APP_NAME = "MyFantasyFocus";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Compare Sleeper and ESPN fantasy lineups for the 2026 NFL season. See who you and your opponent both started, filtered by kickoff window."
			},
			{
				name: "theme-color",
				content: "#0B0F0D"
...
var $$splitComponentImporter = () => import("./routes-DrMdmaOY.mjs");
